...
| **librow** | **Soundtouch** | **<https://www.surina.net/soundtouch/>** | **SoundTouch 是一个开源、跨平台的音频处理库，用于更改音频流或音频文件的速度、音调和播放速率。[https://gitlab.com/soundtouch/soundtouch (源码)]** | **[https://www.gnu.org/licenses/old-licenses/lgpl-2.1.html LGPL-2.1]** | **make** |
...
| **librow** | **Boost.Asio** | **<https://boost.org/libs/asio/>** | **异步及同步网络、定时器、序列 I/O** | **[https://www.boost.org/LICENSE_1_0.txt BSL-1.0]** |
| **librow** | **Boost.Beast** | **<https://boost.org/libs/beast/>** | **建立于 Boost.Asio 顶上的 HTTP 及 WebSocket 库** | **[https://www.boost.org/LICENSE_1_0.txt BSL-1.0]** |
...
| **librow** | **cppsimpleuri** | **<https://github.com/salzaverde/cppsimpleuri>** | **现代 C++ URI & query 解析器** | **MIT** | **cmake** |
...
| **librow** | **curlpp** | **<https://www.curlpp.org/>** | **libcURL（CURL 库）的 C++ 包装。([https://github.com/jpbarrette/curlpp 源码])** | ** | cmake, vcpkg** |
...
| **librow** | **libjson-rpc-cpp** | **<https://github.com/cinemast/libjson-rpc-cpp> | **提供 C++ 跨平台 JSON-RPC（远程过程调用）支持的框架，完全兼容 JSON-RPC 2.0 & 1.0。** | **MIT** | **cmake, conan** |
...
| **librow** | **Unicomm** | **<https://libunicomm.org>** | **异步网络、高层 TCP 通信框架** |
...
| **librow** | **zeromq** | **<https://zeromq.org/>** | **快速消息队列** |
| **并发** |
...
| **librow** | **TBB通过任务窃取和无锁机制，自动化并发管理，实现高性能扩展。或商用** | [源码](https://github.com/oneapi-src/oneTBB)/[**文档**](https://software.intel.com/content/www/us/en/develop/tools/threading-building-blocks/documentation.html ) | [**cmake, make**][https://github.com/oneapi-src/oneTBB/blob/tbb_2020/LICENSE Apache-2.0]
...
| **librow** | **SObjectizer** | **<https://github.com/Stiffstream/sobjectizer>** | **通过行为体和发布/订阅模型，简化开发 C++ 并发和事件驱动应用的小型框架。 | BSD-3-Clause** | **cmake, vcpkg, conan** |
...
| **librow** | **Thrust** | **<https://thrust.github.io/>** | **基于 CUDA、TBB 或 OpenMP 的仿 STL 并行算法及数据结构 | [https://github.com/NVIDIA/thrust#licensing Apache v2.0, Boost v1.0.]** | **cmake** |
...
| **librow** | **FancyArgumentParser | <https://github.com/simfeo/FancyArgumentParser>** | **单头文件 C++11/C++20 命令行解析器，具有与 Python 的 argparse 类似接口，支持具名参数和位置参数，有类型的值，默认值，自动生成的帮助文档，以及通过 C++20 的指派初始化器来支持 Python 风格的关键词实参。** | **MIT** | **仅头文件; vcpkg** |
...
| **librow** | **pugixml** | **<https://pugixml.org/> | C++ 轻量级、简单且快速的 XML 解析器，支持 XPath。 | MIT** | **cmake, conan** |
...
| **librow** | **plf::list** | **<https://www.plflib.org/list.htm>** | **{{lc | std::list** | 实现，为缓存友好牺牲范围切割，导致更快的插入、擦除和迭代。C++98/03/11/14/17/20/23/26/等 兼容。([https://github.com/mattreecebentley/plf_list 源码]) ([https://plflib.org/list.htm 文档])** | **[https://en.wikipedia.org/wiki/Zlib_License zlib]** | **&mdash;** |
...
| **嵌入式/实时系统** |
| **librow** | **distortos** | **<https://distortos.org/>** | **微控制器（ARM, STM32）的面向对象 C++ RTOS ([https://github.com/DISTORTEC/distortos 源码]) ([https://distortos.org/documentation/ 文档])** | **MPL-2.0** | **cmake** |
| **librow** | **ETL** | **<https://www.etlcpp.com>** | **嵌入式模板库 - C++03，为低资源（嵌入式）平台裁剪的可移植模板库 ([https://github.com/ETLCPP/etl.git 源码])** | **MIT** |
...
| **librow** | **QuantLib** | **<https://www.quantlib.org/>** | **定量金融库 - 用于定量金融的自由/开源库 | 修改的 BSD** |
| **游戏引擎架构** |
...
| **librow** | **BOX2D** | **<https://box2d.org/>** | **物理引擎** | **MIT** | **cmake** |
...
| **librow** | **SDL** | **<https://www.libsdl.org/>** | **简单 DirectMedia 层(Simple DirectMedia Layer): 对音频、键盘、鼠标、操纵杆及图形硬件，经由平台上图形 API（OpenGL/Direct3D/Metal/Vulkan）的跨平台低层访问 ([https://wiki.libsdl.org/SDL3/FrontPage 文档]) ([https://github.com/libsdl-org/SDL 源码])** | **zlib** | **cmake** |
...
| **librow** | **cxxomfort** | **<https://ryan.gulix.cl/fossil.cgi/cxxomfort/>** | **C++ 特性逆向移植（ C++11 到 C++03 及 C++1y 提案到 C++11/C++03 ）。** |
...
| **librow** | **fcppt** | **<https://fcppt.org/>** | **Freundlich 的 C++ 工具套 (fcppt) 是聚焦于通过提供更好的类型和函数式编程改进 C++ 代码的库汇集。** |
| **librow** | **Flux** | **<https://github.com/tcbrindle/flux>** | **跨平台 C++20 库，用于“面向序列”编程，与 C++20 ranges 类似，但使用一种基于“游标”的迭代模型，这是对数组索引的推广。([https://tristanbrindle.com/flux/index.html 文档])** | **[http://www.boost.org/LICENSE_1_0.txt BSL-1.0]** | **仅头文件; cmake, vcpkg** |
...
| **librow** | **JUCE** | **<https://www.juce.com/>** | **扩展性的成熟跨平台 C++ 工具套** | **GPL** |
...
| **librow** | **libsourcey** | **<https://sourcey.com/libsourcey/>** | **高速网络化和多媒体编码的跨平台 C++14 库。HTTP 、WebSockets、TURN、STUN、Symple 及更多……** | **LGPL-2.1** | **cmake** |
| **librow** | **LLNL/units** | **<https://github.com/LLNL/units>** | **用于测量单位和其间转换，以及测量单位的字符串表示的运行时库** | **BSD 3-Clause "New" or "Revised" License** | **CMake** |
| **librow** | **Loki** | **<https://loki-lib.sourceforge.net/>** | **C++ 的设计模式库，包含常见设计模式和手法的灵活实现 | MIT** | **make** |
...
| **librow** | **Beman 项目** | **<https://github.com/orgs/bemanproject/repositories?type{{>** | ** | all** | **今日体验未来的 C++ 标准库！一系列拟纳入**标准化**的 C++ 库集合，与最新版本的 C++ 提案保持一致。([https://bemanproject.org 文档])** | **[https://github.com/bemanproject/beman#Apache-2.0-1-ov-file Apache-2.0]** | **cmake, vcpkg** |
| **librow** | **units** | **<https://github.com/nholthaus/units>** | **编译时的量纲分析及单位转换库，建立于 C++14 而无依赖。 | MIT** | **仅头文件** |
| **librow** | **Vix.cpp** | **<https://github.com/vixcpp/vix>** | **一个现代化的 C++ 运行时和开发者工具包，包含命令行界面、构建工作流、网络功能、包注册表集成，以及用于构建 C++ 应用程序的模块化库** | **MIT** | **cmake, make** |
...
| **librow** | **GLAD** | **<https://glad.dav1d.de/>** | **可定制的轻量库，用于加载 OpenGL 功能** |
| **librow** | **GLEW** | **<http://glew.sourceforge.net/>** | **OpenGL 功能加载** |
| **librow** | **GLFW** | **<https://www.glfw.org/>** | **OpenGL 窗口管理器** |
| **librow** | **GLM** | **<https://glm.g-truc.net/>** | **OpenGL 数学库 (GLM) 是 C++ 数学库，用于基于 [https://www.opengl.org/registry/doc/GLSLangSpec.4.50.diff.pdf GLSL] 规范的图形软件。 | [https://github.com/g-truc/glm?tab{{** | ** | License-1-ov-file#readme The Happy Bunny (MIT)]** | **仅头文件; cmake, vcpkg** |
...
| **librow** | **Magnum** | **<https://magnum.graphics>** | **游戏和数据可视化的轻量模块化的 C++11/C++14 图形中间件** |
...
| **librow** | **stats++** | **<https://statsxx.com/>** | **先进、广泛的统计软件：数据收集及预处理、统计、机器学习及优化，拥有开放的 C++ 源码。** |
...
| **librow** | **CGAL** | **<https://www.cgal.org/>** | **计算几何算法库 | GPL-3.0 or commercial** | **cmake** |
| **librow** | **PCL** | **<https://pointclouds.org/>** | **点云库** |
| **librow** | **pmp-library** | **<https://www.pmp-library.org/>** | **多边形网格处理库** |
| **librow** | **Wykobi** | **<https://www.wykobi.com>** | **计算几何库** |
| **anchor | 数学:图论** |
| **图论
...
| **librow** | **FANN** | **<https://leenissen.dk/fann/wp/>** | **快速人工神经网络库** |
...
| **librow** | **Shogun** | **<https://shogun-toolbox.org>** | **大规模机器学习工具箱** |
...
| **librow** | **Brigand** | **<https://github.com/edouarda/brigand>** | **使用急切元函数，为最佳性能优化** | **BSL-1.0** | **cmake, vcpkg** |
| **librow** | **c4-mixins** | **<https://github.com/fare/c4-mixins>** | **一个仅头文件的 C++20 协作式混合（mixin）库，支持 C4 线性化的 {{tt | Super** | 链** | **[https://github.com/fare/c4-mixins/tree/main?tab{{** | ** | License-1-ov-file#License-1-ov-file Apache 2.0/Custom]** | **header-only; cmake** |
...
| **librow** | **ProjectCHRONO** | **<https://projectchrono.org>** | **开源多物理模拟引擎** |
...
| **librow** | **cereal** | **<https://uscilab.github.io/cereal/>** | **C++11 序列化 | BSD** |
...
| **系统** |
| **librow** | **HardwareMonitorCpp** | **<https://github.com/simfeo/HardwareMonitorCpp>** | **一个跨平台硬件遥测库，将各个系统传感器（负载、温度、内存等等）暴露为一个平坦的可查询的数据读取操作的流。支持 Windows/Linux 以及 Apple Silicon 版本的 mac。** | **[https://polyformproject.org/licenses/noncommercial/1.0.0 PolyForm Noncommercial License 1.0.0]** | **cmake** |
